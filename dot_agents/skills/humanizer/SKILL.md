...
description: |
  ...
  text to make it sound more natural and human-written. Triggers: "humanize",
  "humanizer", "remove AI patterns", "make it sound human", "AI-sounding text",
  "de-AI this", or any request to rewrite text that sounds AI-generated. Based
  on Wikipedia's comprehensive "Signs of AI writing" guide. Detects and fixes
