---
name: humanizer-ja
description: AI（Claude、ChatGPT、Gemini等）が生成した日本語テキストから「AIっぽさ」を除去し、人間が書いたように読める文章に書き換えるスキル。ユーザーが「人間っぽくして」「humanize」「AIくさい」「AIっぽい」「機械っぽい」「自然な文章に」等と言ったとき、またはAI生成と分かる日本語テキストを自然な文体に直してほしいという趣旨のリクエストをしたときに必ず使うこと。
version: "1.0.0"
author: SuguruKun_ai
license: MIT
---
...
1. このフォルダを `~/.agents/skills/humanizer-ja/` に配置
2. 文章を生成した後、「人間っぽくして」「humanize」等と指示
